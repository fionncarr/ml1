...
\l p.q
\l fresh.q
\l ts_feature_significance.q
\l tests/significancetests.p
...
/ 1a.
.fresh.fishertest[xbin;ybin] ~ binary_feature_binary_test[xbin;ybin]

/ 1b.
.fresh.ks2samp[ybin;xreal] ~ target_binary_feature_real_test[ybin;xreal]

/ 1c.
.fresh.ktaupy[xreal;yreal] ~ target_real_feature_real_test[xreal;yreal]
...
("i"$count .fresh.benjhochfind[pdict;0.01]) ~ sum vec[0.01]<>1b
("i"$count .fresh.benjhochfind[pdict;0.05]) ~ sum vec[0.05]<>1b
("i"$count .fresh.benjhochfind[pdict;0.5]) ~ sum vec[0.5]<>1b
("i"$count .fresh.benjhochfind[pdict;0.75]) ~ sum vec[0.75]<>1b
("i"$count .fresh.benjhochfind[pdict;0.90]) ~ sum vec[0.90]<>1b
("i"$count .fresh.benjhochfind[pdict;0.99]) ~ sum vec[0.99]<>1b
